...
`deliverables/agent-skill-release-0.6.0.json`, extract it, and load the
extracted plugin directory:

```sh
unzip deliverables/blocksize-market-data-claude-plugin-0.5.0.zip -d /absolute/path/to/unpacked
