...
> availability. Current access is signed x402 for direct public HTTP, a free
> starter allowance only for eligible authenticated connector users (15,000
> free live-data credits every month, then from EUR 49/month via free trial),
> and a contact-sales authenticated account plan for Enterprise. Use
